...
function Cart() {
  return (
    <div className="mt-20 text-2xl font-serif mx-0.5 gap-1.5 flex flex-col mb-20">
      <h2>Cart Summary</h2> 
      <hr />
      ...
      <div className="gap-2 flex">
        ...
        <button className="bg-amber-600 rounded text-white px-7 py-2 text-center gap-1.5 border-white border-2">Checkout tPrice</button>
      </div>
    </div>
  );
}
